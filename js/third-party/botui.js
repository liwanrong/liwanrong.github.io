	...
	var sure = function() {
		...
		secondpart = function() {
			botui.message.add({
				...
				botui.message.add({
					delay: 1500,
					content: "是教师教育学院教育技术学专业的一名大三学生"
				}).then(function() {
					botui.message.add({
						delay: 1200,
						content: "也是一只睡功持续进化、熬夜技能持续进化、扒代码能力持续进化的迷糊小金牛"
					}).then(function() {
						botui.message.add({
							delay: 1500,
							content: "有颗艺术心"
